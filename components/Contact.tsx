        ...
        <div className="rounded-md shadow-md bg-[#F1F1F1] dark:bg-gray-900 p-4 md:p-10 lg:p-20 max-w-6xl mx-auto mb-20 -mt-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="md:ml-4">
                    <header className="">
                    <h1 className="text-gray-900 dark:text-gray-50 font-semibold text-2xl">
                    ...
                    <div className="icons-container inline-flex flex-col my-10">
                        <div className="flex flex-row items-center space-x-6 rounded-md border border-[#F1F1F1] dark:border-gray-900 hover:border hover:border-blue-500 dark:hover:border-gray-50 p-4 mb-2">
                            <svg
                        ...
                        <div className="flex flex-row items-center space-x-6 rounded-md border border-[#F1F1F1] dark:border-gray-900 hover:border hover:border-blue-500 dark:hover:border-gray-50 p-4">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="16"
                                height="16"
